...
const github = 'https://github.com/plucks77';
const bot_version = require('../../package.json').version;

const bot_name = typeof process.env.BOT_NAME === 'undefined' ? 'Music Disc' : ENV.BOT_NAME;
const color = typeof process.env.EMBEDS_COLOR === 'undefined'
  ? '#FFFFFF'
  : ENV.EMBEDS_COLOR;
...
module.exports = {
  ...
  Embed_queue(status, nowplay, queueMsg, loopStatus) {
  ...
  Embed_remove(status, music_title) {
  ...
  Embed_save(music_title, music_url, music_thumbnail, description) {
    const Embed_queue = new Discord.EmbedBuilder()
      .setColor(color)
      .setTitle(music_title)
      .setURL(music_url)
  ...
  Embed_search(music_title, description) {
  ...
  Embed_help(help_title, help_thumbnail, description) {
  ...
  Embed_help2(command, description) {
